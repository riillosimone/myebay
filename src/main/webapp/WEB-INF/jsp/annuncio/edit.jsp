		...
		<div class="container">
			...
			<div class='card'>
				...
				<div class='card-body'>
					...
					<form:form modelAttribute="edit_annuncio_attr" method="post"
						action="${pageContext.request.contextPath}/annuncio/edit"
						...
						<div class="col-md-6">
							...
							<spring:bind path="testoAnnuncio">
								<input type="text" name="testoAnnuncio" id="testoAnnuncio"
									...
									value="${edit_annuncio_attr.testoAnnuncio }" required>
							</spring:bind>
						...
						<div class="col-md-6">
							...
							<spring:bind path="prezzo">
								<input type="number" name="prezzo" id="prezzo"
									...
									value="${edit_annuncio_attr.prezzo }" required>
							</spring:bind>
						...
						<div class="col-md-6 form-check" id="categorieDivId">
							<p>Categoria:</p>
							<form:checkboxes itemValue="id" itemLabel="descrizione"
								element="div class='form-check'"
								items="${categorie_totali_attr}" path="categorieIds" />
						</div>
						<script>
